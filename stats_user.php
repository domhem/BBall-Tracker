...
<html>
  ...
  <body>
    <ul class="tab-group">
      <li class="tab active"><a style="width:100%" href="stats_user.php">Basketball Team Statistics</a></li>
    </ul>

    <ul class="tab-group">
      <li class="tab"><a style="width:33.33%" href="addplayer.php">Add New Player</a></li>
      <li class="tab"><a style="width:33.33%" href="addcoach.php">Add New Coach</a></li>
      <li class="tab"><a style="width:33.33%" href="updateinfo.php">Update Information</a></li>
    </ul>
