  ...
  <body>
    ...
    <?php
      ...
      if(isset($_SESSION['User'])){
        ...
        echo "<ul class=\"tab-group\">";
        echo "<li class=\"tab active\"><a style=\"width:33.33%\" href=\"addplayer.php\">Add New Player</a></li>";
        ...
        echo "<ul class=\"tab-group\">";
        echo "<li class=\"tab active\"><a style=\"width:25%\" href=\"addplayer.php\">Add New Player</a></li>";
    ...
    ?>
        ...
        <td style="vertical-align:top; border:1px solid black;">
          ...
          <form action="processPlayer.php" method="post">
            <table style="margin: 0px auto; border: 0px; border-collapse:separate;">
              ...
              <tr>
               <td colspan="2" style="text-align: center;"><input type="submit" value="Add Player Name and Address" /></td>
              </tr>
            </table>
          </form>
        </td>
